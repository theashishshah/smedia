  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 space-y-10 text-zinc-200">
      ...
      <p className="text-zinc-400">
        {`Ashish Shah AI`} is an open, extensible chat interface built using
        modern web technologies. Developers can contribute, extend personas, and
        integrate the system with their own LLM backends.
      </p>
      ...
      <section className="space-y-4 border border-zinc-800 rounded-2xl p-6 bg-zinc-950">
        ...
        <p className="text-sm text-zinc-400">
          We welcome contributions from the community. Whether it’s improving
          prompts, fixing UI inconsistencies, or adding new personality modes —
          everything helps!
        </p>
        <a
      ...
      <section className="space-y-4 border border-zinc-800 rounded-2xl p-6 bg-zinc-950">
        ...
        <p className="text-sm text-zinc-400">
          If you want to integrate your own model endpoint, you can replace the
          API route in
