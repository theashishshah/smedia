      ...
      {media.map((m) => (
        ...
        >
          ...
          <button
            ...
            className="absolute right-2 top-2 rounded-full bg-black/70 px-2 py-1 text-xs text-white opacity-0 transition group-hover:opacity-100 border border-border hover:bg-black/90"
