            ...
            <div className="mx-auto grid max-w-7xl grid-cols-1 md:grid-cols-2">
                ...
                <div className="relative hidden md:flex items-center justify-center p-8">
                    <div className="absolute inset-0">
                        <div className="h-full w-full bg-gradient-to-br from-zinc-900 via-black to-black" />
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center gap-6">
                        ...
                        <div className="flex h-48 w-48 items-center justify-center">
                            ...
                            <svg viewBox="0 0 512 512" className="h-44 w-44 text-white">
                                <path
                        ...
                        <h1 className="text-5xl font-extrabold tracking-tight">smedia.corp</h1>
